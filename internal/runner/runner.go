...
var AllowedCommands = []string{"echo", "aws", "docker", "docker-compose", "git", "siteops-compiler", "website-compiler", "website-compiler-new", "website-compiler-cli", "compose.sh", "mock-website-compiler.sh", "bash"}
